...
";
if(mysql_query($sql))$msg .="<br>- sales_order..OK";else $msg .="<br>- sales_order..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- sales_order_lineitems..OK";else $msg .="</br>- sales_order_lineitems..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- sales_tax_rates..OK";else $msg .="</br>- sales_tax_rates..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- shipped_via..OK";else $msg .="</br>- shipped_via..<br>ERROR -" . mysql_error();
...
";
	if(mysql_query($sql))$msg .="</br>- source_of_order..OK";else $msg .="</br>- source_of_order..<br>ERROR -" . mysql_error();
