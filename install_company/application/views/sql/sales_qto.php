...
";
if(mysql_query($sql))$msg .="<br>- quotation..OK";else $msg .="<br>- quotation..<br>ERROR -" . mysql_error();
...
";
	if(mysql_query($sql))$msg .="</br>- quotation_lineitems..OK";else $msg .="</br>- quotation_lineitems..<br>ERROR -" . mysql_error();
