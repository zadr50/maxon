...
CREATE TABLE IF NOT EXISTS `".$cid."gl_projects` (
...
CREATE TABLE IF NOT EXISTS `".$cid."gl_projects_budget` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `".$cid."gl_projects_saldo` (
  `id` int(11) NOT NULL auto_increment,
  `project_code` varchar(50) character set utf8 default NULL,
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."gl_report_groups` (
  `id` int(11) NOT NULL auto_increment,
