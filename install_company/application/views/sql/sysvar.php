...
";
if(mysql_query($sql))$msg .="<br>- sysreportdesign..OK";else $msg .="<br>- sysreportdesign..<br>ERROR -" . mysql_error();
...
";
	if(mysql_query($sql))$msg .="</br>- system_variables..OK";else $msg .="</br>- system_variables..<br>ERROR -" . mysql_error();
