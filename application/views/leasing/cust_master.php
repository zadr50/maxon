...
<div id="dlgGambar" class="easyui-dialog"  
 style="width:300px;height:200px;padding:25px 25px;left:100px;top:20px" closed="true" >
...
<div id='dlgProvKab' class="easyui-dialog"  buttons="#tbProvKab"
 style="width:400px;height:500px;padding:5px 5px;left:100px;top:20px" closed="true">
	<div id='divProvKab'>
