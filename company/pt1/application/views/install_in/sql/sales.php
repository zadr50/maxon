...
CREATE TABLE IF NOT EXISTS `".$cid."sales_order` (
...
CREATE TABLE IF NOT EXISTS `".$cid."sales_order_lineitems` (
...
CREATE TABLE IF NOT EXISTS `".$cid."sales_tax_rates` (
...
CREATE TABLE IF NOT EXISTS `".$cid."shipped_via` (
...
CREATE TABLE IF NOT EXISTS `".$cid."source_of_order` (
