...
<table cellspacing="0" cellpadding="1" border="0" width='100%'> 
     <tr>
     	<td colspan='2'><h2>OUTSTANDING PURCHASE ORDER WITH SUPPLIER</h2></td>     	
     </tr>
     <tr>
     	<td>
     ...
     <tr>
 		...
 		<thead>
 			<tr><td>Nomor PO</td><td>Tanggal</td><td>Termin</td><td>Due</td>
 				...
 				<td>Phone</td><td>Jumlah</td><td>Received?</td><td>Outlet</td><td>Sistim</td>
 			</tr>
 		</thead>
 		<tbody>
     			<?php
	 		       ...
	 		       $sql="select p.purchase_order_number,p.po_date,p.terms,p.supplier_number,
	 		        ...
	 		        p.type_of_invoice,p.warehouse_code   
	                from purchase_order p
	                left join suppliers s on s.supplier_number=p.supplier_number
	                where p.received=0 and  p.potype='$potype' and p.po_date between '$date1' and '$date2'";
