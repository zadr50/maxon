...
";
	...
	if(mysql_query($sql))$msg .="<br>- chart_account_link..OK";else $msg .="<br>- chart_account_link..<br>ERROR -" . mysql_error();
...
";
	if(mysql_query($sql))$msg .="</br>- chart_bank_accounts..OK";else $msg .="</br>- chart_bank_accounts..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- chart_of_account_types..OK";else $msg .="</br>- chart_of_account_types..<br>ERROR -" . mysql_error();
