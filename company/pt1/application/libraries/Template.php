...
<link rel='stylesheet' type='text/css' href='$this->fld/assets/bootstrap-3.3.5/css/bootstrap.min.css'>		
  ...
  /// $this->script_head=$this->_ci->jquery->_compile();
	...
	<link rel="stylesheet" type="text/css" href="'.$this->fld.'js/autocomplete/jquery.autocomplete.css">
	<link rel="stylesheet" type="text/css" href="'.$this->fld.'assets/jquery-easyui-1.4.3/themes/'.$themes.'/easyui.css">
	<link rel="stylesheet" type="text/css" href="'.$this->fld.'assets/jquery-easyui-1.4.3/themes/icon.css">
	<link rel="stylesheet" type="text/css" href="'.$this->fld.'themes/'.$themes.'/style.css">
	<link rel="stylesheet" type="text/css" href="'.$this->fld.'assets/datepicker/datepicker.css">
	<link rel="stylesheet" type="text/css" href="'.$this->fld.'assets/bootstrap-3.3.5/css/bootstrap.min.css">
