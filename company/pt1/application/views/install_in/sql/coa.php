<?
$table="".$cid."chart_account_link";
$sql="CREATE TABLE IF NOT EXISTS `".$cid."chart_account_link` (
...
$sql="CREATE TABLE IF NOT EXISTS `".$cid."chart_of_accounts` (
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."chart_of_account_types` (
...
if($link->query($sql))echo mysqli_error($link);
$sql="
INSERT INTO `".$cid."chart_of_account_types` (`account_type_num`, `account_type`, `income_statement_num`, `sub_acc_income`, `update_status`, `sourceautonumber`, `sourcefile`) VALUES
