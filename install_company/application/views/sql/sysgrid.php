...
";
if(mysql_query($sql))$msg .="<br>- sys_grid..OK";else $msg .="<br>- sys_grid..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- sys_objects..OK";else $msg .="</br>- sys_objects..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- sys_tooltip..OK";else $msg .="</br>- sys_tooltip..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- trans_type..OK";else $msg .="</br>- trans_type..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- type_of_account..OK";else $msg .="</br>- type_of_account..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- type_of_payment..OK";else $msg .="</br>- type_of_payment..<br>ERROR -" . mysql_error();
$sql="
