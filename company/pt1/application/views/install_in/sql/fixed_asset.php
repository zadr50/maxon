...
CREATE TABLE IF NOT EXISTS `".$cid."fa_asset` (
...
CREATE TABLE IF NOT EXISTS `".$cid."fa_asset_depreciation` (
...
CREATE TABLE IF NOT EXISTS `".$cid."fa_asset_depreciation_schedule` (
  `asset_id` varchar(10) character set utf8 default NULL,
  `depn_year` int(11) default NULL,
  `depn_id` int(11) default NULL,
  `acquisition_cost` double default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."fa_asset_group` (
  `id` varchar(50) character set utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."fa_asset_service_log` (
...
CREATE TABLE IF NOT EXISTS `".$cid."fa_asset_transaction` (
  `id` int(50) NOT NULL auto_increment,
  `asset_id` varchar(10) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."fa_cards` (
...
CREATE TABLE IF NOT EXISTS `".$cid."fa_setting` (
...
CREATE TABLE IF NOT EXISTS `".$cid."fb_room` (
...
INSERT INTO `".$cid."fb_room` (`room_code`, `room_name`, `regular_hour`, `happy_hour`, `status`, `nota`, `dept`, `RType`, `capacity`, `desciption`, `update_status`) VALUES
