...
<table cellspacing="0" cellpadding="1" border="0" width='800px'> 
     ...
     <tr>
        <td colspan="8">
                <table class='titem'>
                <thead>
                    <tr><td>Tanggal</td><td>Voucher</td><td>Giro#</td><td>Tgl.Giro</td>
                ...
                foreach($rst_bank->result() as $r_bank){
                    ...
                    i.from_bank,i.cleared_date,i.trans_id,
                    i.deposit_amount,i.payment_amount,i.supplier_number,i.payee,i.memo
                     from check_writer i 
                    where (i.cleared is null or i.cleared=0) and i.trans_type in ('cheque in','cheque out') and account_number='".$r_bank->bank_account_number."' 
