...
<div class="alert alert-info">
			<h4 class="red ta-center mb-10">Informasi Keamanan</h4>
				<div class=" mt-40 ml-10 mr-15 mb-50">
					<i class="icon-locked fs-50"></i>
						...
						<div class=" fs-12 lh-18" style='padding-bottom:50px'>
							<ul><li class="">
	...
	<div class="col-sm-6 col-md-6 col-lg-6">
		...
		<?=load_view("eshop/customers/member_form");?>		
...
function frmMain_Save(){
  		if($('#customer_number').val()==''){log_err('Isi username !');return false;}
  		if($('#company').val()==''){log_err('Isi nama anda !');return false;}
