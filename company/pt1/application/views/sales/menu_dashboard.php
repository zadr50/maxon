...
<div class="easyui-tabs" id="tt">	 
	...
	<div title="Sales Dashboard" style="padding:1px"  class="easyui-panel themes" title="Saldo Hutang Supplier" 
			...
			<img src="<?=$fld?>images/sales.png" usemap="#sales" class="map">
		...
		<div title="Sales Dashboard" style="padding:10px"  class="easyui-panel themes" title="Saldo Hutang Supplier" 
			...
			<div id="p" class="" title="Total Penjualan"  
				...
				<div id='divSales'  style="float:left;width:500px;height:200px;padding:5px;">
					<img src="<?=$fld?>images/loading.gif">
				</div>
			</div>			
		</div> 	 	
	</div>
    ...
    <div class='row' >
        <div class='col-lg-12'>
        <div title="Daftar Laporan" style="padding:10px"  class="easyui-panel themes" 
            data-options="iconCls:'icon-help',closable:true,
            collapsible:true,minimizable:true,maximizable:true">          
...
<script type="text/javascript" src="<?=$fld?>assets/flot/jquery.flot.pie.js"></script>
