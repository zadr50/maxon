...
class Product_cost extends CI_Controller {
    ...
    private $sql="select item_number,description,unit_of_measure,i.category,i.sub_category ,i.retail,i.cost 
                from inventory i
				where i.class='Employee'
                ";
   private $file_view='manuf/product_cost';
   private $controller="product_cost";
	...
	{
        $data['caption']='DAFTAR BIAYA TENAGA KERJA';
		$data['controller']=$this->controller;		
		$data['fields_caption']=array('Kode','Nama Barang','Unit','Kelompok','Sub','Cost','Supplier');
		$data['fields']=array('item_number','description','unit_of_measure','category','sub_category','cost','supplier_name');
