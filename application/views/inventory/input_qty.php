<div id='dgItemForm' class="easyui-dialog" 
    style="width:550px;height:400px;padding:5px 5px;top:10px;"
    ...
    <form id="frmItem" method='post' >
            <table class='table2' style='width:100%'>
             ...
             <tr><td>Quantity</td><td><input id="quantity"  style='width:60px'  name="quantity" 
             	onblur="hitung();">
            ...
            <tr><td>Akun Hpp</td><td><?=form_input("cost_account","","id='cost_account' style='width:250px' ")?>
             ...
             <tr><td>Id</td><td><input id="id"  style='width:60px'  name="id" readonly></tr>
            </table>
    </form>
</div>
<div id="tbItemForm">
