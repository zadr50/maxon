	...
	<div id="p" class="easyui-panel" title="Themes" 
			...
			<form id="" method="post">
				<div class="row">
					...
					<div class="col-sm-5">
						<?=form_radio("sidebar_position","left",$sidebar_position=='left'?'left':'');?> Left
						<?=form_radio("sidebar_position","right",$sidebar_position=='right'?'right':'');?> Right
					</div>
				</div>
				<div class="row">
                ...
                <div class="row">
                    <label class="control-label col-sm-5" for="chatbox">Don't validate journal posting</label>
