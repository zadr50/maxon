...
$table="check_writer";
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."check_writer` (
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."check_writer_deposit_detail` (
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."check_writer_items` (
  `trans_id` int(11) default NULL,
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."check_writer_print_settings` (
...
$ql="
CREATE TABLE IF NOT EXISTS `".$cid."check_writer_recurring_payments` (
...
if($link->query($sql))echo mysqli_error($link);
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."check_writer_recurring_payment_items` (
  `payment_number` int(11) default NULL,
  `line_number` int(11) NOT NULL auto_increment,
  `account_id` int(11) default NULL,
  `amount` double default NULL,
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."check_writer_undeposited_checks` (
