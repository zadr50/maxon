...
class Kereta_model extends CI_Model {
	...
	function __construct(){
		...
		$this->load->model('travel/kereta_type_model');
		...
		$this->fields[]=array('name'=>'kereta','type'=>'nvarchar','size'=>50,'caption'=>"Nama Kereta",
			'control'=>'dropdown','list'=>$this->kereta_type_model->list_kereta());
