...
<div id='dlgSelectPinjam'class="easyui-dialog" style="width:600px;height:380px;padding:10px 20px"
     closed="true" buttons="#tbPinjam">
     <div id='divSelectPinjam'> 
		<table id="dgSelectPinjam" class="easyui-datagrid"  
			data-options="
				toolbar: '',
				singleSelect: true,
				url: ''
