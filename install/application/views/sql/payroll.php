...
if(mysql_query($sql))$msg .="</br>- hr_emp_angsuran..OK";else $msg .="</br>- hr_emp_angsuran..<br>ERROR -" . mysql_error();
...
if(mysql_query($sql))$msg .="</br>- hr_emp_default_com..OK";else $msg .="</br>- hr_emp_default_com..<br>ERROR -" . mysql_error();
...
if(mysql_query($sql))$msg .="</br>- hr_emp_level_com..OK";else $msg.="</br>- hr_emp_level_com..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- hr_emp_loan..OK";else $msg.="</br>- hr_emp_loan..<br>ERROR -" . mysql_error();
...
if(mysql_query($sql))$msg .="</br>- hr_pph..OK";else $msg .="</br>- hr_pph..<br>ERROR -" . mysql_error();
...
if(mysql_query($sql))$msg .="</br>- hr_pph_form..OK";else $msg .="</br>- hr_pph_form..<br>ERROR -" . mysql_error();
...
if(mysql_query($sql))$msg .="</br>- employee_pph..OK";else $msg .= "</br>- employee_pph..<br>ERROR -" . mysql_error();
$sql=" 
...
if(mysql_query($sql))$msg .="</br>- hr_shift..OK";else $msg .="</br>- hr_shift..<br>ERROR -" . mysql_error();
...
if(mysql_query($sql))$msg .="</br>- hr_ptkp..OK";else $msg .="</br>- hr_ptkp..<br>ERROR -" . mysql_error();
