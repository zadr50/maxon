...
CREATE TABLE IF NOT EXISTS `".$cid."customers` (
...
CREATE TABLE IF NOT EXISTS `".$cid."customers_other_info` (
...
CREATE TABLE IF NOT EXISTS `".$cid."customer_beginning_balance` (
...
CREATE TABLE IF NOT EXISTS `".$cid."customer_shipto` (
...
CREATE TABLE IF NOT EXISTS `".$cid."customer_statement_defaults` (
  `id` int(11) NOT NULL auto_increment,
