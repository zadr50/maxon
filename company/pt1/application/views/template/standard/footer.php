...
$url=$fld."/index.php/".$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3);
///		add_log_run($url);
?>
<div style="float:none;clear:both;"></div>
<div id='footer' name='footer' class="col-md-12 col-lg-12">
	<div class='col-lg-5'>
		<img src='<?=$fld?>images/logo_maxon.png' style='float:left;margin:5px'>
	...
	<div class='col-md-5'>
		...
		<div>
			<a href="http://www.facebook.com/maxon51" target="_new" title="Follow Facebook">
					<img src="<?=$fld?>images/fb.png" style='width:50px;height:50px'></a>
			<a href="http://www.twitter.com/talagasoft" target="_new" title="Follow Twitter">
				<img src="<?=$fld?>images/twitter.png"  style='width:50px;height:50px'>
			</a>
		</div>
