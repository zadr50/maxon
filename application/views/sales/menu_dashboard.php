	...
	<div title="DASHBOARD">
		...
		<div title="Saldo" style="padding:10px"  class="easyui-panel themes" title="Saldo Hutang Supplier" 
			...
			<div id="p" class="" title="Total Penjualan"  
				...
				<div id='divSales'  style="float:left;width:90%;height:300px;padding:5px;">
					<img src="<?=base_url()?>images/loading.gif">
				</div>
			</div>			
		</div>
	   ...
	   <div class='row'>
	       <div class='col-md-4'>
                <table id="dgOutlet" class="easyui-datagrid"  height=400
            ...
            <div class='col-md-8'>
                <table id="dgRetur" class="easyui-datagrid"  
                    ...
                    data-options="title: 'Faktur Jatuh Tempo',
                        iconCls: 'icon-tip',fitColumns: true,
                        singleSelect: true,
                        toolbar: '',
