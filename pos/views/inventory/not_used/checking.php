	   ...
	   <h3>Formulir ini dipakai memilih nomor bukti workorder untuk dipersiapkan
	   	pada proses selanjutnya yaitu proses packing dan shipping</h3>
		<?php echo $message;?>
	   <?php echo validation_errors(); ?>
	   <?php echo form_open('checking/next_step_2');?>
	   <?php 
		$this->db->select('wo_number,wo_date,so_number,customer');
		$this->db->where('picking','1');
		$this->db->where('checking is null',NULL,FALSE);
