...
<div class="thumbnail">
	...
	echo link_button('Add','','add','false',base_url().'index.php/leasing/loan/add');		
	echo link_button('Search','','search','false',base_url().'index.php/leasing/loan');		
	if($mode=="view") echo link_button('Refresh','','reload','false',base_url().'index.php/leasing/loan/view/'.$loan_id);		
	echo link_button('Delete', 'loan_delete()','remove');		
	if($posted) {
		echo link_button('UnPosting','','cut','false',base_url().'index.php/leasing/loan/unposting/'.$loan_id);		
	} else {
		echo link_button('Posting','','ok','false',base_url().'index.php/leasing/loan/posting/'.$loan_id);		
	}
...
<div id='divLoan_Proses' name='divLoan_Proses' class="easyui-dialog" 
	style="width:500px;height:480px;padding:10px 20px;left:100px;top:20px" closed="true" 
	buttons="#tbProses">
