...
<tr><td>Kode Barang</td><td><?=form_input('kode',"A"," style='width:50px'")?></td>
	<td>Nama Barang</td><td><input type='text' name='nama' id='nama' value='B' style="width:50px"></td>
        <td>Sistim</td><td><input type='text' name='type_of_invoice' id='type_of_invoice' value='' style="width:50px"></td></tr>
...
<tr><td>Kode Divisi</td><td><input type='text' name='division' value='N' style="width:50px"></td>
	<td>Qty Awal</td><td><input type='text' name='qty' value='' style="width:50px"></td><td></td>
	</tr>
