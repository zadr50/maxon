...
";
if(mysql_query($sql))$msg .="<br>- report_list..OK";else $msg .="<br>- report_list..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- rpt_open_to_buy..OK";else $msg .="</br>- rpt_open_to_buy..<br>ERROR -" . mysql_error();
