	...
	for($y=0;$y<20;$y++){
		...
		$amountp="0";
			...
			if($amount+$amountp>0){
				...
				$tbl.="<td>".$jenis."</td>";
				$s="";$s1="";
				if($amount<>0)$s=number_format($amount,2);
				if($amountp<>0)$s1=number_format($amountp,2);
	   ...
	   $tbl="<tr><td><strong>Total</strong></td>
		<td align=\"right\"><strong>".number_format($tot_dapat,2)."</strong></td>
		<td><strong>Total</strong></td><td align=\"right\"><strong>".number_format($tot_potong,2)."</strong></td></tr>";
	   echo $tbl;
?>	 
     <tr><td colspan="3"><h1><strong>Jumlah </strong></h1></td>
	 <td align="right"><h1><strong><?=number_format($tot_dapat-$tot_potong,2)?></strong></h1></td></tr>
</table>
