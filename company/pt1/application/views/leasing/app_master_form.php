...
<div class="thumbnail box-gradient">
	...
	if($show) echo link_button('Add','','add','false',base_url().'index.php/leasing/app_master/add');		
	echo link_button('Search','','search','false',base_url().'index.php/leasing/app_master');		
	if($mode=="view") echo link_button('Refresh','','reload','false',base_url().'index.php/leasing/app_master/view/'.$app_id);		
