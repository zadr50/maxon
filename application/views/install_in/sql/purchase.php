...
CREATE TABLE IF NOT EXISTS `".$cid."other_vendors` (
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."suppliers` (
...
CREATE TABLE IF NOT EXISTS `".$cid."supplier_beginning_balance` (
