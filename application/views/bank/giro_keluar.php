...
?>
<div class="col-lg-12" >
 	<legend>Daftar Giro keluar yang belum cair</legend>
        ...
        <table id="dgCard" class="easyui-datagrid"  
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="<?=col_number("payment_amount")?>">Jumlah</th>
...
<script type="text/javascript">
    ...
    function search_cards()
    {
        ...
        var rek=$("#rekening").val();
        if(rek=='')rek='undefined';
        var xurl='<?=base_url()?>index.php/banks/giro/keluar_not_cleared/?d1='+d1+'&d2='+d2+"&rek="+rek;
