	...
	<div title="General" style="padding:10px">
		...
		<table class="table" width="100%">
			<tr>
			   ...
			   <tr>
			       <td>Nomor Bukti Masuk</td><td><?php echo form_input('no_bukti_in',$no_bukti_in,"style='width:400px;'");?></td>
			   </tr>
			   <tr>                   
			       <td>Nomor Bukti Keluar</td><td><?php echo form_input('no_bukti_out',$no_bukti_out,"style='width:400px;'");?></td>
                </tr>
