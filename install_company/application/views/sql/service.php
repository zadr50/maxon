...
";
if(mysql_query($sql))$msg .="<br>- service_jobs..OK";else $msg .="<br>- service_jobs..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- service_job_sparepart..OK";else $msg .="</br>- service_job_sparepart..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- service_order..OK";else $msg .="</br>- service_order..<br>ERROR -" . mysql_error();
