<div class="thumbnail box-gradient"> 
	...
	if($mode!=="add"){
		...
		echo link_button('Delete','','remove','false',base_url().'index.php/stock_mutasi/delete/'.$transfer_id);		
	    if($posted){
...
<div class="easyui-tabs" >
			...
			<table id="dg" class="easyui-datagrid" width=120% height=300 
				...
				<thead>
					<tr>
	                    ...
	                    <th data-options="<?=col_number('total_amount',2)?>">Amount</th>
	...
	<?=load_view("gl/jurnal_view",array("gl_id"=>$transfer_id));?>
</div>
