...
<div class='alert alert-info'>
    <p>Isi seting kolom dibawah ini sesuai dengan kolom di excel, 
        ...
        Contoh file template file TXT silahkan download disini 
         <?=anchor(base_url()."import/master_customer.rar","master_customer.rar")?> 
    </p>    
</div>
...
<tr><td>Kode Pelanggan</td><td><?=form_input('kode',"A"," style='width:50px'")?></td>
	<td>Nama Pelanggan</td><td><input type='text' name='nama' id='nama' value='B' style="width:50px"></td>
    <td>Handphone</td><td><input type='text' name='hp' value='J' style="width:50px"></td>
	</tr>
...
<tr><td>Kota</td><td><input type='text' name='kota' value='E' style="width:50px"></td>
    ...
    <td>Kode Kelompok</td><td><input type='text' name='kelompok' value='L' style="width:50px"></td>
	</tr>
...
<tr><td>Saldo Awal Piutang</td><td colspan="7">
        ...
        <i style='font-size:11px'>*apabila saldo_awal diisi proses import  akan otomatis 
           membuat nomor bukti baru faktur penjualan kredit sebagai saldo awal,
           dan total piutang akan mengupdate saldo awal perkiraan.   
        </i></td>
</tr>
<tr><td colspan=8> <input type='checkbox' name='chkUpdateCoaPiutang' style="width:30px"/> 
