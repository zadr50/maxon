...
";
if(mysql_query($sql))$msg .="<br>- purchase_order..OK";else $msg .="<br>- purchase_order..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- purchase_order_lineitems..OK";else $msg .="</br>- purchase_order_lineitems..<br>ERROR -" . mysql_error();
