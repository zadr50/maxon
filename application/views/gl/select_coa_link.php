...
<div id='dlgCoa' class="easyui-dialog"  style="width:610px;height:400px;padding:5px 5px;left:100px;top:20px"
		  ...
		  pagination:true,
			...
			<thead>
				<tr>
                    ...
                    <th data-options="field:'group_type',width:80">Group</th>
