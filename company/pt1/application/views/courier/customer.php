<div class="thumbnail box-gradient">
	...
	echo link_button('Add','','add','false',base_url().'index.php/courier/customer/add');		
	echo link_button('Refresh','','reload','false',base_url().'index.php/courier/customer/view/'.$customer_number);		
	echo link_button('Search','','search','false',base_url().'index.php/courier/customer');		
...
<!-- TARIF ZONE -->
   <?php if($mode=="edit" || $mode=='view') { ?>
    <div title="Special Tarif" style="padding:10px">
        <?php 
            $url=base_url()."index.php/courier/tarif";
            $lov_service2="";
            $cust_no=$customer_number;
            include_once "tarif_special.php";             
        ?>
    </div>    
    <?php } ?>
