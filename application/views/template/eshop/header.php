<nav class="navbar-maxon navbar" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <button type='button' style='color:white' class="navbar-toggle glyphicon glyphicon-align-justify" 
		data-toggle="collapse" 
		data-target="#eshop-navbar-collapse-1"
		></button>
	  
	</div> 
	<div class="nav-collapse"  id="eshop-navbar-collapse-1">	  
