...
";
if($link->query($sql))$msg .="<br>- qry_coa..OK";else $msg .="<br>- qry_coa..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_adj..OK";else $msg .="</br>- qry_kartustock_adj..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_delivery..OK";else $msg .="</br>- qry_kartustock_delivery..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_etc_out..OK";else $msg .="</br>- qry_kartustock_etc_out..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_invoice..OK";else $msg .="</br>- qry_kartustock_invoice..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_purchase..OK";else $msg .="</br>- qry_kartustock_purchase..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_receipt..OK";else $msg .="</br>- qry_kartustock_receipt..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_transfer..OK";else $msg .="</br>- qry_kartustock_transfer..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- qry_kartustock_union..OK";else $msg .="</br>- qry_kartustock_union..<br>ERROR -" . mysql_error();
