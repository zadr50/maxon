<div><h4>FORMULIR PENGAMBILAN TABUNGAN</H4>
<div class="thumbnail">
	<?php
...
<div class="easyui-tabs" style="width:auto;height:auto;min-height:300px">
	...
	<form id="frmLoan"  method="post">
	   ...
	   <table>
			...
			<tr>
				<td>Tanggal Ambil</td><td><?php echo form_input('nip',$nip,"id=nip"); echo link_button("","lookup_employee()","search")?></td>
			</tr>
		   <tr>
				<td>Jenis Transaksi</td><td><?=form_input('date_loan',$date_loan,"class='easyui-datetimebox' style='width:150px'");?></td>
		   </tr>
		   <tr>
				<td>Nomor Simpanan</td><td><?=form_input('loan_amount',$loan_amount);?></td>
		   </tr>
			<tr>
				<td>Jumlah Pengambilan</td><td><?=form_dropdown('rate_method',array("Bunga Flat","Bunga Menurun"),$rate_method);?></td>
				<td>Jumlah Biaya</td><td><?=form_input('rate_percent',$rate_percent,"id=rate_percent");?></td>
			</tr>
	...
	<div title='Daftar 10 Transaksi'><?php include_once "transaksi.php" ?></div>

</div>	
	
<?php include_once "anggota_lookup.php" ?>
