...
CREATE TABLE IF NOT EXISTS `".$cid."payroll_link` (
...
CREATE TABLE ".$cid."hr_emp_angsuran (
...
CREATE TABLE ".$cid."hr_emp_default_com (
	id int(11) NOT NULL auto_increment,
	nip varchar (50) character set utf8 NOT NULL ,
...
CREATE TABLE ".$cid."hr_emp_level_com (
	id int(11) NOT NULL auto_increment,
...
CREATE TABLE ".$cid."employee_shift (
	id int(11) NOT NULL auto_increment,
	nip varchar (50) character set utf8 NULL ,
...
INSERT INTO ".$cid."hr_ptkp(kode,keterangan,jumlah)
