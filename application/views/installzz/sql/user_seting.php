...
";
if($link->query($sql))$msg .="</br>- user..OK";else $msg .="</br>- user..<br>ERROR -" . mysql_error();
...
";
	if($link->query($sql))$msg .="</br>- user_group_modules..OK";else $msg .="</br>- user_group_modules..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- user_job..OK";else $msg .="</br>- user_job..<br>ERROR -" . mysql_error();
