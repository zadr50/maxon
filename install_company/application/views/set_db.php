	...
	<div class='thumbnail'>
	   ...
	   <div class='row'>
			<div class='col-md-10' id='divFrm'>
				<form id="frmSet" method="post" action="<?=base_url()?>index.php/welcome/cek_db_process">
...
$(document).ready(function() {
    $('#frmSetxxxxx').submit(function(event) { //Trigger on form submit
		var url = "<?=base_url()?>index.php/welcome/cek_db_process"; // the script where you handle the form input.
...
function create_tables()
{
	...
	url="<?=base_url()?>index.php/welcome/cek_db_process_2";
		$.ajax({
			   type: "POST", url: url,
			   data: $("#frmSet").serialize(), // serializes the form's elements.
			   success: function(data)
			   {
				   if(IsJsonString(data)){
					   ...
					   if(result.success){
						   ...
						   url="<?=base_url()?>index.php/welcome/set_web";
