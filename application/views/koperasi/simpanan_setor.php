...
<div class="easyui-tabs" style="width:auto;height:auto;min-height:300px">
	...
	<form id="frmLoan"  method="post">
	   ...
	   <table>
		   ...
		   <tr>
				<td>Jenis Transaksi</td><td><?=form_input('loan_amount',$loan_amount);?></td>
		   </tr>
			<tr>
				<td>Nomor Simpanan</td><td><?=form_dropdown('rate_method',array("Bunga Flat","Bunga Menurun"),$rate_method);?></td>
				<td>Jumlah Setoran</td><td><?=form_input('rate_percent',$rate_percent,"id=rate_percent");?></td>
			</tr>
		   <tr>
				<td>Administrasi</td><td><?=form_input('pokok',$pokok);?></td>
				<td>Total</td><td><?=form_input('bunga',$bunga);?></td>       
		   </tr>
