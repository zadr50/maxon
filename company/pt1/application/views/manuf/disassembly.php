...
<legend>PROSES DISASSEMBLY</legend>
	...
	<script type="text/javascript">
		function load_help() {
			window.parent.$("#help").load("<?=base_url()?>index.php/help/load/disassembly");
		}
	</script>
...
<form id="myform" role="form" method="post" action="<?=base_url()?>index.php/assembly/save"  class="form-horizontal" >
	...
	<label for="date_received" class="col-sm-3 control-label">Tanggal</label>
		<div class="col-sm-8">
			...
			style="width:150px" name="date_received" 
			data-options="formatter:format_date,parser:parse_date"
			value="<?=$date_received?>" placeholder="">
		</div>
	</div>
	...
	<div class="form-group">
	<label for="quantity_received" class="col-sm-3 control-label">Qty</label>
		<div class="col-sm-8">
