...
";
if($link->query($sql))$msg .="<br>- sysreportdesign..OK";else $msg .="<br>- sysreportdesign..<br>ERROR -" . mysql_error();
...
";
	if($link->query($sql))$msg .="</br>- system_variables..OK";else $msg .="</br>- system_variables..<br>ERROR -" . mysql_error();
