...
CREATE TABLE IF NOT EXISTS `".$cid."promosi_disc` (
...
CREATE TABLE IF NOT EXISTS `".$cid."promosi_extra_item` (
...
";
if($link->query($sql))echo mysqli_error($link);$table="promosi_item";

$sql="

CREATE TABLE IF NOT EXISTS `".$cid."promosi_item` (
  `promosi_code` varchar(50) character set utf8 default NULL,
  `item_number` varchar(50) character set utf8 default NULL,
  `description` varchar(50) character set utf8 default NULL,
  `table_name` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."promosi_item_category` (
  `id` int(11) NOT NULL auto_increment,
  `promosi_code` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."promosi_item_customer` (
  `id` int(11) NOT NULL auto_increment,
  `promosi_code` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."promosi_outlet` (
  `outlet` varchar(50) character set utf8 default NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `".$cid."promosi_point_transactions` (
  `id` int(11) NOT NULL auto_increment,
  `cust_code` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."promosi_time` (
