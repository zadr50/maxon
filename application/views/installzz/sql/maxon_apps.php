...
";
if($link->query($sql))$msg .="<br>- maxon_apps..OK";else $msg .="<br>- maxon_apps..<br>ERROR -" . mysql_error();
$sql="
...
";
if($link->query($sql))$msg .="</br>maxon_chat..OK";else $msg .="</br>maxon_chat..<br>ERROR -" . mysql_error();
$sql="
...
";
if($link->query($sql))$msg .= "</br>- maxon_inbox..OK";else $msg .= "</br> - maxon_inbox..<br>ERROR -" . mysql_error();
$sql="
...
";
if($link->query($sql))$msg .= "</br> - syslog..OK";else $msg .= "</br> - syslog..<br>ERROR -" . mysql_error();
