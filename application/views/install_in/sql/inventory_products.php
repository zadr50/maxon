...
CREATE TABLE IF NOT EXISTS `".$cid."inventory_products` (
...
CREATE TABLE IF NOT EXISTS `".$cid."inventory_promotion` (
...
CREATE TABLE IF NOT EXISTS `".$cid."inventory_sales_disc` (
  `item_number` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."inventory_serialized_items` (
  `item_number` varchar(50) character set utf8 default NULL,
  `shipment_id` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."inventory_suppliers` (
  `item_number` varchar(50) character set utf8 default NULL,
  `supplier_number` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."inventory_warehouse` (
  `item_number` varchar(50) character set utf8 default NULL,
