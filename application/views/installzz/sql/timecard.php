...
if($link->query($sql))$msg .="</br>- qry_payroll_component..OK";else $msg .="</br>- qry_payroll_component..<br>ERROR -" . mysql_error();
...
if($link->query($sql))$msg.="</br>- sys_log_run..OK";else $msg.="</br>- sys_log_run..<br>ERROR -" . mysql_error();
