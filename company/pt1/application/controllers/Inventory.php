...
//		$data['supplier_list']=$this->supplier_model->select_list();
    ...
    function browse_data($offset=0,$limit=10,$nama=''){
		...
		if(!is_numeric($offset)){
			$sql.=" and description like '5$offset%'";
		}  else {
			...
			if($this->input->get('sid_supp')!='')$sql.=" and supplier_name like '%".$this->input->get('sid_supp')."%'";
			if($this->input->get('sid_cat')!='')$sql.=" and category like '%".$this->input->get('sid_cat')."%'";
            if($search!='')$sql.=" and description like '%$search%' or item_number='$search' ";
		}
