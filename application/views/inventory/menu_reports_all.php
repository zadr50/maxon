<div class='col-lg-6'>
<h3>Analisys Reports</h3>    
<li><?=anchor('inventory/rpt/daftar','Daftar Barang',"class='info_link'")?></li>
<li><?=anchor('inventory/rpt/price_list','Price List Harga Jual Barang',"class='info_link'")?></li>
<li><?=anchor('inventory/rpt/daftar_cost','Daftar Barang Harga Beli, HPP',"class='info_link'")?></li>
<li><?=anchor('inventory/rpt/daftar_supplier','Daftar Barang Per Supplier',"class='info_link'")?></li>
...
<li><?=anchor('inventory/rpt/konsi_sum','Summary Hutang Konsinyasi','class="info_link"')?></li>
<li><?=anchor('inventory/rpt/konsi_detail','Rincian Hutang Konsinyasi','class="info_link"')?></li>
</div>
<div class="col-lg-6">
    <h3>Stock Reports</h3>

<li><?=anchor('inventory/rpt/cards_summary','Kartu Stock Summary',"class='info_link'")?></li>
<li><?=anchor('inventory/rpt/cards_detail','Kartu Stock Detail',"class='info_link'")?></li>
<li><?=anchor('inventory/rpt/cards_gudang','Kartu Stock Per Gudang',"class='info_link'")?></li>
<li><?=anchor('inventory/rpt/cards_supplier','Kartu Stock Per Supplier',"class='info_link'")?></li>
