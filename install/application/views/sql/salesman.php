...
";
if(mysql_query($sql))$msg .="<br>-- salesman..OK";else $msg .="<br>-- salesman..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- salesman_group..OK";else $msg .="</br>- salesman_group..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- salesman_group_komisi..OK";else $msg .="</br>- salesman_group_komisi..<br>ERROR -" . mysql_error();
...
";
	if(mysql_query($sql))$msg .="</br>- salesman_komisi..OK";else $msg .="</br>- salesman_komisi..<br>ERROR -" . mysql_error();
