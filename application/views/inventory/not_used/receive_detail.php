...
<script type="text/javascript">
    ...
    function append(){
        ...
        console.log(param);
        xurl='<?=base_url()?>index.php/receive/add_item';
        $.ajax({
                    type: "GET",
                    url: xurl,
                    data: param,
     ...
     function remove_item(){
            ...
            if (row){
                            xurl=CI_ROOT+'receive/delete_item/'+row['id'];                             
                            console.log(xurl);
                            xparam='';
                            $.ajax({
                                    type: "GET",
     ...
     function refresh_items(){
         param="";
         get_this('<?=base_url()?>index.php/receive/view_detail/<?=$shipment_id?>',param,'dgItem');
         return false;
     }   
      function save_item(){
        var url="<?=base_url()?>index.php/receive/save_item";
