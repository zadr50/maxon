...
$table="invoice";
	...
	$sql="
CREATE TABLE IF NOT EXISTS `".$cid."invoice` (
...
CREATE TABLE IF NOT EXISTS `".$cid."invoice_delivery_order_info` (
...
CREATE TABLE IF NOT EXISTS `".$cid."invoice_lineitems` (
...
CREATE TABLE IF NOT EXISTS `".$cid."invoice_serialized_items` (
  `id` int(11) NOT NULL auto_increment,
  `invoice_number` varchar(50) character set utf8 default NULL,
  `item_number` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."invoice_shipment` (
  `id` int(11) NOT NULL auto_increment,
  `invoice_number` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."invoice_shipment_export` (
  `invoice_number` varchar(50) character set utf8 default NULL,
...
CREATE TABLE IF NOT EXISTS `".$cid."invoice_tax_serial` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `".$cid."kas_kasir` (
...
CREATE TABLE IF NOT EXISTS `".$cid."kendaraan` (
