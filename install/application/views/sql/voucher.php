...
";
if(mysql_query($sql))$msg .="<br>- voucher_master..OK";else $msg .="<br>- voucher_master..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- wilayah..OK";else $msg .="</br>- wilayah..<br>ERROR -" . mysql_error();
...
";
if(mysql_query($sql))$msg .="</br>- yescalendaricons..OK";else $msg .="</br>- yescalendaricons..<br>ERROR -" . mysql_error();
...
";
	if(mysql_query($sql))$msg .="</br>- yes_smartsearchdefinition..OK";else $msg .="</br>- yes_smartsearchdefinition..<br>ERROR -" . mysql_error();
