...
CREATE TABLE IF NOT EXISTS `".$cid."sys_grid` (
...
CREATE TABLE IF NOT EXISTS `".$cid."sys_objects` (
...
CREATE TABLE IF NOT EXISTS `".$cid."sys_tooltip` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `".$cid."trans_type` (
...
CREATE TABLE IF NOT EXISTS `".$cid."type_of_account` (
...
CREATE TABLE IF NOT EXISTS `".$cid."type_of_payment` (
...
";
if($link->query($sql))echo mysqli_error($link);$sql="

INSERT INTO `".$cid."type_of_payment` (`type_of_payment`, `discount_percent`, `discount_days`, `days`, `update_status`, `sourceautonumber`, `sourcefile`) VALUES
