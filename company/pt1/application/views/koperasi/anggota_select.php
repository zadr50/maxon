<!-- PILIH ANGGOTA --> 
<div id='dlgSelectAng'class="easyui-dialog" style="width:600px;height:380px;padding:10px 20px;left:100px;top:20px"
     closed="true" buttons="#tbAng">
     <div id='divSelectAng'> 
		<table id="dgSelectAng" class="easyui-datagrid"  
			data-options="
				toolbar: '',
				singleSelect: true,
				url: ''
