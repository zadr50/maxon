...
CREATE TABLE IF NOT EXISTS `".$cid."finance_charge_defaults` (
...
CREATE TABLE IF NOT EXISTS `".$cid."financial_periods` (
...
INSERT INTO `".$cid."financial_periods` (`year_id`, `sequence`, `period`, `startdate`, `enddate`, `closed`, `update_status`, `id`) VALUES
...
CREATE TABLE IF NOT EXISTS `".$cid."gl_begbalarc_year` (
...
CREATE TABLE IF NOT EXISTS `".$cid."gl_beginning_balance_archive` (
  `account_id` int(11) default NULL,
  `company_code` varchar(15) character set utf8 default NULL,
  `year` datetime default NULL,
  `beginning_balance` double default NULL,
