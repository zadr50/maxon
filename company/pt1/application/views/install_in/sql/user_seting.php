...
CREATE TABLE IF NOT EXISTS `".$cid."org_struct` (
...
CREATE TABLE IF NOT EXISTS `".$cid."user` (
...
INSERT INTO `".$cid."user` (`user_id`, `username`, `password`, `path_image`, `update_status`, `disc_prc_max`, `disc_amt_max`, `email`, `NIP`, `userlevel`, `active`, `cid`) VALUES
...
CREATE TABLE IF NOT EXISTS `".$cid."user_group_modules` (
...
INSERT INTO `".$cid."user_group_modules` (`id`, `group_id`, `module_id`, `permission`, `update_status`, `sourceautonumber`, `sourcefile`) VALUES
...
CREATE TABLE IF NOT EXISTS `".$cid."user_job` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `".$cid."user_job` (`id`, `user_id`, `group_id`, `update_status`, `sourceautonumber`, `sourcefile`) VALUES
