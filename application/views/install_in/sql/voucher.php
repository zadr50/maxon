...
CREATE TABLE IF NOT EXISTS `".$cid."voucher_master` (
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."wilayah` (
...
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."yescalendaricons` (
...
if($link->query($sql))echo mysqli_error($link);
$sql="
CREATE TABLE IF NOT EXISTS `".$cid."yes_smartsearchdefinition` (
