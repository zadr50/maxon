...
<div class='btn-group col-md-6' role='group' aria-label='Record'>
  <div class="col-md-4">
    <div class="input-group">
      <input name='page' id='page' value=1 type="text" class="form-control" placeholder="Page">
  ...
  <div class="col-md-6">
    <div class="input-group">
      <input name='rows' id='rows' value='10' type="text" class="form-control" placeholder="Row Count">
      <span class="input-group-btn">
