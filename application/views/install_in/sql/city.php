...
CREATE TABLE IF NOT EXISTS `".$cid."city` (
...
CREATE TABLE IF NOT EXISTS `".$cid."crdb_memo` (
...
CREATE TABLE IF NOT EXISTS `".$cid."crdb_memo_dtl` (
...
CREATE TABLE IF NOT EXISTS `".$cid."credit_card_type` (
...
INSERT INTO `".$cid."credit_card_type` (`id`, `card_type`, `update_status`, `sourceautonumber`, `sourcefile`, `card_name`, `to_date`, `from_date`, `disc_percent`) VALUES
...
CREATE TABLE IF NOT EXISTS `".$cid."currencies` (
...
INSERT INTO `".$cid."currencies` (`currency_code`, `description`, `update_status`) VALUES
('IDR', 'Rupiah', NULL),
('USD', 'Dollar', NULL);
";
