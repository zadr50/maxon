<div class='col-md-4'>
<li><?=anchor('sales/rpt/so_otstand','Open Sales Order (SO)',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/so_otstand_item','Open SO by Item Number',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/so_otstand_cust','Open SO by Customer Number',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/so_list','Daftar Sales Order (SO)',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/so_items','Sales Order by Item',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/so_salesman','Sales Order by Salesman',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/so_customer','Sales Order by Customer',"class='info_link'")?></li>
<li><?=anchor('sales/rpt/do_list','Daftar Delivery Order (DO)',"class='info_link'")?></li>
...
<li><?=anchor('sales/rpt/sls_supplier','Pernjualan per Item Supplier',"class='info_link'")?></li>
