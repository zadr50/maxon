...
<p>Contoh file template file TXT silahkan download disini 
 <?=anchor(base_url()."import/master_supplier.rar","master_supplier.rar")?> </p>
...
<tr><td>Kode Supplier</td><td><?=form_input('kode',"A"," style='width:50px'")?></td>
	<td>Nama Supplier</td><td><input type='text' name='nama' id='nama' value='B' style="width:50px"></td></tr>
...
<tr><td>Telpon 2</td><td><input type='text' name='no_telp2' value='' style="width:50px"></td>
...
<tr><td>Termin</td><td><input type='text' name='payment_terms' value='' style="width:50px"></td>
