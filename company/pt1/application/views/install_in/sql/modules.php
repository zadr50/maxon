...
CREATE TABLE IF NOT EXISTS `".$cid."modules` (
...
$sql="
INSERT INTO `".$cid."modules` (`module_id`, `module_name`, `type`, `form_name`, `description`, `parentid`, `update_status`, `sequence`, `visible`, `controller`) VALUES
...
;
";
if($link->query($sql))$msg .="<br>-Data $table..OK";else $msg .="<br>-$table..<br>ERROR -" . mysqli_error($link);

$table="modules_group";
$sql="

CREATE TABLE IF NOT EXISTS `".$cid."modules_groups` (
...
INSERT INTO `".$cid."modules_groups` (`user_group_id`, `user_group_name`, `creation_date`, `description`, `path_image`, `update_status`, `sourceautonumber`, `sourcefile`) VALUES
