...
";
if($link->query($sql))$msg .="</br>- suppliers..OK";else $msg .="</br>- suppliers..<br>ERROR -" . mysql_error();
...
";
if($link->query($sql))$msg .="</br>- supplier_beginning_balance..OK";else $msg .="</br>- supplier_beginning_balance..<br>ERROR -" . mysql_error();
