...
<div class="thumbnail box-gradient">
	...
	if($show) echo link_button('Add','','add','false',base_url().'index.php/website/articles/add');		
	echo link_button('Search','','search','false',base_url().'index.php/website/articles');		
	if($mode=="view") echo link_button('Refresh','','reload','false',base_url().'index.php/website/articles/view/'.$id);		
...
<script type="text/javascript">
    function save_this(){
		url='<?=base_url()?>index.php/website/articles/save';
		$('#myform').form('submit',{
